  ...
  return (
    <div className="doctor-profile-card">
      ...
      <div className="doctor-profile-details">
        ...
        <div className="doctor-profile-detail-item"><Icon name="location" /><div><span className="detail-label">Location</span>{doctor.locationUrl ? <a className="doctor-map-link detail-value" href={doctor.locationUrl} target="_blank" rel="noreferrer">{doctor.location}</a> : <span className="detail-value">{doctor.location}</span>}</div></div>
